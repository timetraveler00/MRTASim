...
public final class FLS {
	...
	// imrovements are possible (local optima).
        while(visited < numCities) {
        	//System.out.println("visited: " + visited + " numCities: "+numCities);
            final Point currentPoint = points[current];
            System.out.println("currentPoint: "+currentPoint.index + " point type "+currentPoint.pointType + " xloc: "+currentPoint.x + " yloc: "+currentPoint.y+ " active? "+currentPoint.isActive());
