...
public  class RobotAgent extends GuiAgent {
	...
	private Robotum robots[] = new Robotum[MAX_ROBOTS]; // Duyuru yapan b�t�n
														// robotlar�n listesi
	private int robotCount = 0; // Duyuru yapan robot say�s�

	private Random randomGenerator = new Random();
	private float robotStep = (float) 8.0;
	private int motionInterval = 25; // ms.
...
System.out.println("expMode: "+expMode);
		...
		// trade yakla��m� d* ise ya da d*-tpm ise
		if (TRADE_APPROACH == eBidValuation.DSTARLITE || TRADE_APPROACH == eBidValuation.TMPTSP  || TRADE_APPROACH == eBidValuation.DSTARLITETSP ) {
			...
			// dsl ��z�m� di�er robotlarda bitmemi� olabilir. Bu nedenle birka�
	...
	public void SearchForRobots() {
	 ...
	 public void CreateMap() throws Exception {
		...
		// methodMap.put("0000", RobotAgent.ListenNReply.class.getMethod("RandomTaskCheck", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));
		 methodMap.put("00", RobotAgent.ListenNReply.class.getMethod("Proposal", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));
		 methodMap.put("09", RobotAgent.ListenNReply.class.getMethod("EndOfTour", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));
		 methodMap.put("04", RobotAgent.ListenNReply.class.getMethod("BuyTaskFromAuctioneer", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("04RAR", RobotAgent.ListenNReply.class.getMethod("CompleteSellingProcess", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("04RNR", RobotAgent.ListenNReply.class.getMethod("TradeCompleted", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("066", RobotAgent.ListenNReply.class.getMethod("TaskCompletionAcknowledge",ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
			
		 methodMap.put("10", RobotAgent.ListenNReply.class.getMethod("EndOfTrade", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("61", RobotAgent.ListenNReply.class.getMethod("SimulationStarted", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("91", RobotAgent.ListenNReply.class.getMethod("LogToFile", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("103", RobotAgent.ListenNReply.class.getMethod("TaskAccepted", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("104", RobotAgent.ListenNReply.class.getMethod("TaskRejected",ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("112", RobotAgent.ListenNReply.class.getMethod("IBecomeSELLER", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("115", RobotAgent.ListenNReply.class.getMethod("TradeIsOver", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("116", RobotAgent.ListenNReply.class.getMethod("ExecutionStart", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("121", RobotAgent.ListenNReply.class.getMethod("MakeABid", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("122", RobotAgent.ListenNReply.class.getMethod("IncomingBid", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("123", RobotAgent.ListenNReply.class.getMethod("BuyTaskFromRobot", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
		 methodMap.put("191", RobotAgent.ListenNReply.class.getMethod("Reset", ACLMessage.class, String.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class));	
	...
	public void AddUpdateRobot(String rName) {
		...
		/*
		 * BU FONKSIYONDA PARAMETRELER�N GE�ERL�L�K KONTROL� YAPILMAMI�TIR.
		 * GE�ERL� G�NDER�LD��� VARSAYILMI�TIR.
		 */
	...
	public void AddUpdateTask(String tName, String xLoc, String yLoc, String bundleHead, String price, boolean mine, eTradeStatus tradeSt, eTaskState taskSt) {
		...
		} else {   // TASK BUNDLE g�revlerim aras�nda ise   
	...
	public boolean MyStation(Station st) {
		// E�er robotun konumu istasyonun konumu civar�ndaysa
		// �rne�in 10 birim
	 ...
	 */
		...
		Yaz(thisRobot.robotName + " > CreateSchedule_MTP");
			...
			if ((TSP_MODE == eTSPLoopMode.TSP_PATH || TSP_MODE==eTSPLoopMode.TSP_TOUR) || stationCount == 0) {
				...
				Yaz(thisRobot.robotName + " > CreateSchedule_MTP() -> Final istasyona �izelgeleme YAPILAMADI !!!! - Uygun istasyon bulunamad� ");
			}
			} // else 
			if (tmpPath!=null /*&& st!=null*/) 
			{
				CreateScheduleMTP (tmpPath, st); 
				Yaz(thisRobot.robotName + " > CreateSchedule_MTP() -> �izelge tamamland� : ");
				ScheduleTime(begin);
			}
			else 
			{
				Yaz(thisRobot.robotName + " > !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  ");
				Yaz(thisRobot.robotName + " > CreateSchedule_MTP() -> �izelgeleme eylemi ba�ar�s�z !!!!  ");
				Yaz(thisRobot.robotName + " > !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  ");
			}
		...
		public TSPMinPath BestStation () 
		{
			...
			for (int i = 0; i < stationCount; i++) {
				...
				if (IsInExtendedBoundary(st.xLoc, st.yLoc) || MyStation(st)) {
					...
					if (stLen < minLen) {
						...
						minSt = st; 
						Yaz(thisRobot.robotName + "> �imdilik en k�sa path  s�ra : " + mini + " uzunluk : " + minLen + " st " + st.taskName + "(" + st.xLoc + "-"+ st.yLoc + ")");
						//PrintPath (path[i]); 
						PrintPath (tmpp); 
						//PrintPath (tspm); 
			...
			if (mini >-1) 
			{
						Yaz(thisRobot.robotName + "> Se�ilen istasyon : " + mini + " uzunluk : " + minLen + " st " + minSt.taskName + "(" + minSt.xLoc + "-"+ minSt.yLoc + ")");
	      //  PrintPath(tspm);
...
/*
			Yaz(thisRobot.robotName + " robotunun �izelgesi"); 
...
*/
	...
	public void StartExecution() {
		...
		if (WaitingTasks() > 0) {
			...
			Yaz(thisRobot.robotName + " StartExecution - Yapacak g�rev yok ");
		} 
	...
	public boolean EvaluateProposals_Sequential() {
		...
		if (mini > -1) {
			...
			Yaz(thisRobot.robotName + "> "
					+ taskQueue[tradedTask].GetTask(0).taskName + " g�revinin "
					+ robots[mini].robotName
					+ " robotuna sat�� i�lemi ba�lat�ld�.");
			SellTask_Sequential(mini, tradedTask);

			return true;

			// // Yaz("task sat�ld� - reset");
	...
	public void CompleteSellingProcess(ACLMessage msg, String temp[]) {
		...
		Yaz(thisRobot.robotName + "> " + taskSold
				+ " g�revinin sat�� i�lemi tamamland�.");
		...
		if (WaitingTasks() == 0) {
			Yaz(thisRobot.robotName
					+ "> "
					+ taskSold
					+ " g�revinin sat�� i�lemi sonucunda ba�ka g�revim kalmad�.");
			thisRobot.status = eRobotStatus.IDLE;
			addBehaviour(new InformLocationOnce());
		} else {
			Yaz(thisRobot.robotName + "> " + taskSold
					+ " g�revinin sat�� i�lemi sonucu hala g�revim var.");
		...
		protected void onWake() {
			if (ExecutingNow == null) {
				if (Math.abs(thisRobot.xLoc - thisRobot.startX) < 5
					...
					Yaz(thisRobot.robotName + "> Ba�lang�ca d�n�yorum.");
					PrintWallWatch();
	 ...
	 */
		...
		protected void onTick() {
			...
			if (inactionTicker > 1000) {
				...
				Yaz(thisRobot.robotName + "> BEL�RL� B�R S�RE HAREKET TESP�T ED�LEMED�.......");
				ExecutingNow = null;
				thisRobot.status = eRobotStatus.IDLE;
				inactionTicker = 0;
				if (WaitingTasks() > 0)
	...
	public void CreateFinalSchedule_Optimal(Station st) {
		...
		if (st != null) 
			Yaz(thisRobot.robotName + "> CreateFinalSchedule_Optimal()  tamamland� st : " + st.taskName + " time : " + (end - begin));
	...
	public void GetWay_Optimal(Task fr, Task to) {
		...
		Yaz(thisRobot.robotName + "> GetWay_Optimal()  tamamland� fr : "
	...
	public void GetWay_RRT(Task fr, Task to) {
		...
		if (is_main.InterSection(w)) {
			...
			if (istemp != null) {   // iki d���m aras�nda engel varsa 
				...
				if (frc!=null && frt!=null) 
				{
					...
					if (fr_to != null && fr_to.size() > 0)    // en yak�n d���mler aras�nda en k�sa yol mevcutsa
						for (Vertex vertex : fr_to) { 					
			...
			{
				Yaz(thisRobot.robotName + "> Get way RRT'de rrt path graf� olu�turulamad�: indoorstructure eksik ");
			}
...
*/
	...
	//	executionOrder_final[exeTasks++] = to;
		//Yaz(thisRobot.robotName + "> Pathe eklenen Task : " + to.taskName 	+ "   -  " + Integer.toString(exeTasks));
		long end = System.currentTimeMillis();
		Yaz(thisRobot.robotName + "> GetWay_RRT()  tamamland� fr : " + fr.taskName + " to : " + to.taskName + " time : " + (end - begin));
	...
	public void GetWay_DStar(Task fr, Task to) {
		...
		Yaz(thisRobot.robotName + "> GetWay_DStar()  tamamland� fr : " + fr.taskName + " to : " + to.taskName + " time : " + (end - begin));
	...
	public void GetWay_Bresenham(Task fr, Task to) {
		...
		BasicPoint bp = null; 
		if (is_main.InterSection(w)) {
            System.out.println ("getway_bresenham: from-to aras�nda engel var, en k�sa yol aranacak!");
			LinkedList<Vertex> fr_to = is_main.ShortestofClosests(fr, to);
		...
		Yaz(thisRobot.robotName + "> GetWay_Bresenham()  tamamland� fr : "+ fr.taskName + " to : " + to.taskName + " time : "+ (end - begin));
	...
	// Robota o an TSP hesab�na g�re s�radaki g�revini bulur ve oray� ziyaret
	// eder.
		...
		public void action() {
			...
			if (Executing == null && executingTask < exeTasks) {
				if (executionOrder_final[executingTask] != null) {
					...
					Yaz(thisRobot.robotName + ">" + Executing.taskName + " gorevine ba�lad�m. State :" + Executing.state);
					Yaz(thisRobot.robotName + ">" + Executing.taskName + " xloc "+Executing.xLoc + " yloc "+Executing.yLoc);
				} else {
					Yaz(thisRobot.robotName
							+ "> "
							+ executingTask
							+ ". s�radaki g�rev ge�ersiz, bir sonrakine ge�iyorum.");
	...
	// Satma karar� verildi�inde ilgili robota mesaj g�nderir.
	...
	// Sat�n alma karar� verilmeyen teklifleri yapan robotlara sonucun olumsuz
	// oldu�u mesajla bildirilir.
	...
	// ARENA'ya anl�k pozisyon bilgisi periyodik olarak g�nderilir.
	// Yer de�i�imi fazla de�ilse mesaj y�k�n� �nlemek a��s�ndan lokasyon
	// g�nderilmeyebilir.
	 ...
	 */
		...
		public void action() {
			...
			thisRobot.pickUpTime = CompletedTasks() * estimatedPickUpDuration; // pickup time burada hesaplan�yor
			ACLMessage msg = new ACLMessage(ACLMessage.INFORM);
			msg.addReceiver(new AID(terrain, AID.ISLOCALNAME));
			msg.setLanguage("English"); 
			
			String strContent = "71_" + thisRobot.robotName + "_" // 
					+ Integer.toString(thisRobot.xLoc) + "_" 
					+ Integer.toString(thisRobot.yLoc) + "_"
					...
					+ Integer.toString(thisRobot.rect.x1) + "_"    // g�revler i�in 
					+ Integer.toString(thisRobot.rect.y1) + "_"
					+ Integer.toString(thisRobot.rect.x2) + "_"
					+ Integer.toString(thisRobot.rect.y2) + "_"
					+ Integer.toString(thisRobot.outerRect.x1) + "_" // istasyonlar i�in 
				...
				/*	+ Double.toString(thisRobot.heading)+"_"
					+ Integer.toString(thisRobot.numberOfSectors);
			for (int i=0;i<thisRobot.numberOfSectors;i++) 
			{
				
				strContent += "_"  + thisRobot.meanProximities[i];
			}*/
	 ...
	 */
		...
		protected void onWake() {
			...
			Yaz(thisRobot.robotName
					+ "> END OF A TRADE MESAJI 113 G�NDER�LD�  !!!!  ");
	...
	public int FindMostUnavailable_Sequential(eBidValuation approach) {
		...
		for (int i = 0; i < myTaskBundles; i++) {
			...
			if (/*taskQueue[i].offered == false & */taskQueue[i].tradeStatus == eTradeStatus.OWNED
				...
				Yaz(thisRobot.robotName + " > MEVCUT G�REVLER�MDEN "
						+ tb.GetTask(0).taskName + " �IKARILIRSA KAZANCIM : "
						+ len);
				if (len > maxLength) {
					maxLength = len;
					maxi = i;
	...
	public int CalcTPDistance(Task from, Task to) {
		...
		// �ki g�rev aras�na engel geliyorsa durum kar���k
		if (is_main.InterSection(w)) {
...
/*
	...
	public double TSPLength(eBidValuation approach) {
		...
		if (mytempTaskBundles > 0) {   // g�rev yoksa direk 0 d�nd�r 
			long begin = System.currentTimeMillis();
			double minLen = 10000000;
			int mini = -1;
			TSPMinPath path = null;

			if ((TSP_MODE==eTSPLoopMode.TSP_PATH || TSP_MODE==eTSPLoopMode.TSP_TOUR)  || stationCount == 0) {  // �stasyona d�nmesi gerekmiyorsa 
				path = TSPCreate(null);
				minLen = path.TSPPathLength();
				mini = 999;

			} else { // istasyonlar varsa en uygununu aramak zorundad�r. 
				for (int i = 0; i < stationCount; i++) {
					Station st = is_main.GetStation(i);
					path = TSPCreate(st);
			...
			if (mini > -1) {
				...
				Yaz(thisRobot.robotName + "> TSPLength - Hesaplanamad�  " + " time : " + (end - begin));
				return -1;
			}
		} 
		/*else if (mytempTaskBundles>0 && mytempTaskBundles<3)
		{
			...
			Yaz(thisRobot.robotName + "> TSPLength - G�rev olmad��� i�in s�f�r (0)  ");
			return 0;
		}
	}
	...
	//	else if (approach==eBidValuation.TMPRRTTSP || approach==eBidValuation.TMPTSP || approach==eBidValuation.DSTARLITETSP)
		...
		/*switch (approach) {
		case 1: // 1 : Proposal_Euclidian : D�REK UZAKLIK
	...
	public class StartAnAuctionOnce_Sequential extends OneShotBehaviour {
		...
		public void action() {
			...
			if (worstTaskForMe != null && IsInHeatBoundary(worstTaskForMe)) {
				...
				PrepareRobotReceivers(); // df ten t�m robotlar listelenir 
				taskQueue[worstIndex].price = worstTaskForMe.price; //Pricing (worstTaskForMe, TRADE_APPROACH);
				Yaz(thisRobot.robotName + ">  " + worstTaskForMe.GetTask(0).taskName + " GOREVINI SATISA CIKARIYORUM. BEDELI  : " + Integer.toString((int) taskQueue[worstIndex].price) + " Hesaplama Y�ntemi "+ TRADE_APPROACH);
				...
				SendACLMessage(rcd, 1, mcd, 7);   // terraine sat��a ��kar�lan g�rev bilgisi
				...
				SendACLMessage(rc1, robotCount, mc1, 7);  // m�zayedeciye sat��a ��kar�lan g�rev bilgisi
				propCount = 0;
	 ...
	 */
		...
		protected void onTick() {
			...
			// Yaz (thisRobot.robotName+"> MoveRobot onThick()");
			if (Executing != null ) {
				Yaz(thisRobot.robotName + "> Task : " + Executing.taskName);
				int tx = Executing.xLoc;
				int ty = Executing.yLoc;
				int rx = thisRobot.xLoc;
				int ry = thisRobot.yLoc;
				/*int sur = Surroundings(tx, ty); 
				while (sur!=rw*11) 
				{
					Yaz(thisRobot.robotName + ">     Task : " + Executing.taskName + "  sur "+sur );
					int xf = (sur - rw*11)/10;
					...
					//tx += (randomGenerator.nextInt(2)-1); 
					//ty += (randomGenerator.nextInt(2)-1); 
					sur = Surroundings(tx, ty);
					Yaz(thisRobot.robotName + ">     Task : " + Executing.taskName + " xf "+ xf+ "yf "+yf +" tx "+tx + " ty "+ty + " sur "+sur );
				}
*/
				double nWay = Math.sqrt((tx - rx) * (tx - rx) + (ty - ry)* (ty - ry));
				//Yaz(thisRobot.robotName + "> nWay : " + nWay);
				if (nWay < robotStep) {
					thisRobot.xLoc = tx;
					thisRobot.yLoc = ty;
					thisRobot.cumulativeWay += nWay;
				}
				else {
					// double h = 5.0;
					// robotStep
					...
					double xx = robotStep * Math.cos(angle * Math.PI / 180);
					double yy = robotStep * Math.sin(angle * Math.PI / 180);
					...
					thisRobot.energyLevel -= instantWay;
					thisRobot.cumulativeWay += instantWay;

					thisRobot.xLoc = thisRobot.xLoc + (int) fx;
					thisRobot.yLoc = thisRobot.yLoc + (int) fy;
				}
				// Hedefe 3 pikselden daha yak�nla��rsa G�rev tamamlan�r
				Yaz(thisRobot.robotName + "> Hareket tamam");

				if ((Math.abs(ty - thisRobot.yLoc) < robotStep)
						&& (Math.abs(tx - thisRobot.xLoc) < robotStep)) {

					addBehaviour(new TaskCompletion());
					// robotStep = (float) 8.0;
				...
				Yaz(thisRobot.robotName + " Executing : " + Executing.state);
			}
		...
		public void action() {
			...
			if (ProposalsCompleted_Sequential()) {
				...
				if (EvaluateProposals_Sequential()) {
					...
					Yaz(thisRobot.robotName
							+ "> **** SATI� BA�ARILI  , ONAY BEKLEN�YOR  ****  ");
				} else {
					Yaz(thisRobot.robotName + "> SATI� BA�ARISIZ  !!!!  ");
					I_CAN_TRADE = false; 
				...
				if (robotCount == 1)
					tradeCompleted = true;
				Yaz(thisRobot.robotName
						+ "> END OF A TRADE MESAJI 113 G�NDER�L�YOR  !!!!  ");
				addBehaviour(new EndOfATrade(thisa, 1000));

			} else {
				Yaz(thisRobot.robotName
						+ "> Teklif de�erlendirmeye ge�ecek kadar teklif gelmedi !!! ");
				propCount++;
				tradeCompleted = true;
...
/*public void SendTaskInformationToTerrain_finished(Task t) {
	...
	public class TaskCompletion extends OneShotBehaviour {
		...
		public void action() {
			...
			if (Executing != null) {
				...
				Yaz(thisRobot.robotName + ">" + Executing.taskName 	+ " gorevini tamamlad�m..." + myTBI1);
	...
	public void ShowProposals_Sequential() {
		...
		if (tradedTask > -1) {
			...
			Yaz ("Sat�sa c�kar�lan gorev :  " + taskQueue[tradedTask].GetTask(0).taskName);
			Yaz(" ");
	 ...
	 * 
	 * case 1: // 1 : Proposal_Euclidian : Robotun g�reve uzakl��� prop =
	 * PrepareAProposal_Euclidian (temp[2], temp[3], temp[4], temp[6]); break;
	 * 
	 * /*case 2: // 2: ProposalY: Robotun g�reve en yak�n g�revine uzakl��� + en
	 * yak�n g�revinin o g�reve uzakl��� = toplam mesafesi prop =
	 * PrepareAProposalY (temp[2], temp[3], temp[4], temp[5]); break; * case 3:
	 * // 3: G�revi eklesem yolum ne kadar de�i�ir? prop =
	 * PrepareAProposalDSTARLITE(temp[2], temp[3], temp[4], temp[6]) ;
	 * Yaz(thisRobot
	 * .robotName+"> "+temp[1]+" robotundan gelen "+temp[6]+" de�erindeki "
	 * +temp[2]+" gorevine teklif verdim DSTARLITE : "+Integer.toString(prop));
	 * break; case 4: // 3: G�revi eklesem yolum ne kadar de�i�ir? prop =
	 * PrepareAProposalDSTARLITE(temp[2], temp[3], temp[4], temp[6]) ;
	 * Yaz(thisRobot
	 * .robotName+"> "+temp[1]+" robotundan gelen "+temp[6]+" de�erindeki "
	 * +temp[2]+" gorevine teklif verdim DSTARLITE : "+Integer.toString(prop));
	 * break;
	 * 
	 * case 5: // 5: direk uzakl�k + en yak�n g�revimden uzakl�k prop =
	 * PrepareAProposalRRT (temp[2], temp[3], temp[4], temp[6]);
	 * Yaz(thisRobot.robotName
	 * +"> "+temp[1]+" robotundan gelen "+temp[6]+" de�erindeki "
	 * +temp[2]+" gorevine teklif verdim RRT : "+Integer.toString(prop)); // Bu
	 * yakla��mda iki robot da kar��l�kl� olarak birbirlerinin g�revlerini sat�n
	 * ald��� i�in avantaj kayboluyor. break; case 6: // 6: AP3 TSP APproach
	...
	public void TradeIsOver(ACLMessage msg, String temp[]) {
		Yaz(thisRobot.robotName
				+ "> ### 115 ### trade sona erdi ,�izelgelemeye ge� ....TRADINGPHASE : "
				+ tradingPhase);
	...
	// Inner class
	// Listen and Reply Messages - Teklif Mesajlar�n� dinler ve cevap verir.
	 ...
	 */
		...
		public void TaskAccepted(ACLMessage msg, String temp[]) {
			 ...
			 */
			Yaz(thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
			Yaz(thisRobot.robotName + "> " + temp[1] + " robotundan " + temp[2] + " gorevini sat�n ald�m ve havuza ekledim ..");
			Yaz(thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		...
		public void SimulationStarted(ACLMessage msg, String temp[]) {
			...
			Yaz(thisRobot.robotName + "> ��letim modu   : " + EXECUTION_MODE);
			is_main = new IndoorStructure(templateSelect);
			simSpeed = Integer.parseInt(temp[2]);

			// simSpeed * robotStep * motionInterval = 8000 olmal�
			// pist uzunlu�u 3750 mt.
			// ekran ��z�n�rl��� 1920 *1080
			// 1 pixel yakla��k 4mt ye kar��l�k geliyor.
			...
			// normalde olmas� gereken (1.38 pixel)
			/*
		...
		*/
		 ...
		 public void RandomTaskCheck(ACLMessage msg, String temp[]) {
				...
				Yaz("*******************************************************************************");
				Yaz(thisRobot.robotName + " robotundan " + temp[1] + " g�revine mesafe : " + dist);
				Yaz("*******************************************************************************");
				...
				if (dist < 0 || dist > 1000) {
					...
					Yaz (thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
					Yaz (thisRobot.robotName + "> MUZAYEDECI'den al�nan " + temp[1] + " gorevini havuza ekledim .." + temp[2] + "_" + temp[3] + "_" + temp[6]);
					Yaz (thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		...
		/* 
		 ...
		 {
			 Yaz(thisRobot.robotName + " 116 GELD�, eXECUT�ON BA�LIYOR");
		...
		public void MessageParse(ACLMessage msg, String temp[]) throws Exception {
			...
			// Teklif al�n�yor ve cevaplan�yor
			...
			/*
			 * G�revlendirme gelirse temp0 kod 04 temp1 taskName temp2 xloc
			 * temp3 yloc temp4
			...
			// 066 : Tamamlanan G�rev Bildirimi
			...
			// Task bildirimi tamamland�, Teklif bekleniyor.
	...
	*/
		...
		public void MakeABid(ACLMessage msg, String temp[]) {
			//getCallerMethod();
			Yaz (thisRobot.robotName + "> MAKEABID " + temp[1] + " robotundan gelen " + temp[6] + " de�erindeki " + temp[2] + " gorevine teklif verece�im ");
			// thisRobot.status = 1;
			if (MyTaskBundleIndex(temp[2]) < 0 ) {    // Benim g�revim mi? 
				int prop = 0;
				
				if (IsInHeatBoundary(temp[3], temp[4]) && WaitingTasks() < thisRobot.capacityExtra)  // Task sorumluluk alan� i�erisinde mi ve yeni g�rev i�in kapasite var m�? 
				{
				...
				Yaz(thisRobot.robotName + "> " + temp[1] + " robotundan gelen " + temp[6] + " de�erindeki " + temp[2] + " gorevine teklif verdim : " + TRADE_APPROACH + " : " + Integer.toString(prop));
				PrintWallWatch();
			}
		}
		...
		public void BuyTaskFromAuctioneer(ACLMessage msg, String temp[]) {
			...
			if (EXECUTION_MODE == eExecutionMode.AGILE) {
				...
				if (WaitingTasks() < capacity && IsInHeatBoundary(temp[2], temp[3])) {
					...
					Yaz(thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
					Yaz(thisRobot.robotName + "> MUZAYEDECI'den al�nan " + temp[1] + " gorevini havuza ekledim .." + temp[2] + "_" 	+ temp[3] + "_" + temp[4] + "_" + temp[5]);
					Yaz(thisRobot.robotName + "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
			...
			//if (WaitingTasks() < thisRobot.capacityExtra) {
				...
				System.out
						.println(thisRobot.robotName
								+ "> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
				Yaz(thisRobot.robotName + "> " + temp[1]
						+ " 'den al�nan " + temp[2] + " gorevini havuza ekledim .."
		...
		public void EndOfTrade(ACLMessage msg, String temp[]) {
			...
			if (Integer.parseInt(temp[1]) == 1) // �nceki turda sat�� ba�ar�l� olmu�  
			{
				ResetOffers();
		...
		public int Valuation (Task t, eBidValuation approach, String price) 
		{
			...
			/*
			switch (approach) {
			// G�revler ilk defa atanaca�� i�in 100000 ile
			// k�yaslan�yor.
			case 1:
				// 1 : Proposal_Euclidian : D�REK UZAKLIK
		...
		public void EndOfTour(ACLMessage msg, String temp[]) {
			...
			if (thisRobot.status == eRobotStatus.IDLE) {
				for (int i = 0; i < taskBundleCount; i++) {
					...
					Task t = tb.GetTask(0);
					if (tb.state == eTaskState.NOT_STARTED) {
						Yaz(thisRobot.robotName + "> " + tb.GetTask(0).taskName + " GOREVINE TEKL�F HAZIRLIYORUM .. state : " + tb.state + " trade status : " + tb.tradeStatus);
	...
	// Yeni bir g�rev eklenirse yolum ne kadar uzar?
