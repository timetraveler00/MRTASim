...
/*
  public static void main(String[] args) {
    ...
    for (double[] row : distanceMatrix) java.util.Arrays.fill(row, 9999);
    
    
    distanceMatrix[0][1] = 100;
    distanceMatrix[0][2] = 423;
    distanceMatrix[0][3] = 500;
    distanceMatrix[0][4] = 583;
    
    distanceMatrix[1][2] = 360;
    distanceMatrix[1][3] = 423;
    distanceMatrix[1][4] = 500;
    
    distanceMatrix[2][1] = 360;
    distanceMatrix[2][3] = 100;
    distanceMatrix[2][4] = 200;

    distanceMatrix[3][1] = 423;
    distanceMatrix[3][2] = 100;
    distanceMatrix[3][4] = 100;
    
    distanceMatrix[4][1] = 500;
    distanceMatrix[4][2] = 200;
    distanceMatrix[4][3] = 100;
