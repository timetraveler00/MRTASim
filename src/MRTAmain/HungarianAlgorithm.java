...
public class HungarianAlgorithm {
	...
	public HungarianAlgorithm (double[][] fArray) 
	{
		System.out.print("HUNGARIAN>CONSTRUCTOR ... ");
		int numOfRows = fArray.length; 
		int numOfCols = fArray[0].length; 
		array = new double[numOfRows][numOfCols];
	...
	public static int[][] hgAlgorithm (double[][] array, String sumType)
	{
		...
		int[][] assignment = new int[array.length][3];	//Create the returned array.
	...
	public int[][] HungarianStart() 
	{
		...
		int[][] assignment = new int[array.length][3];
